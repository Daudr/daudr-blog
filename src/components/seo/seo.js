...
export const SEO = ({
  ...
  const itHref = `${site.siteMetadata.siteUrl}/it${
    typeof location === 'string'
      ? location.replace('/it', '')
      : location.pathname.replace('/it', '')
  }`
  const enHref = `${site.siteMetadata.siteUrl}${
    typeof location === 'string'
      ? location.replace('/it', '')
      : location.pathname.replace('/it', '')
  }`
  ...
  if (postSEO) {
    ...
    schemaOrgJSONLD.push({
      '@type': 'BlogPosting',
      image: image,
      url: `${site.siteMetadata.siteUrl}${lang === 'it' ? '/it' : ''}${slug}`,
  ...
  return (
    ...
    >
      ...
      <link rel='alternate' hreflang='it' href={itHref}></link>
      <link rel='alternate' hreflang='en' href={enHref}></link>
    </Helmet>
  )
}
